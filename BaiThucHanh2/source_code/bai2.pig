...
stop_raw = LOAD 'bai_thuc_hanh/stopwords.txt' USING PigStorage('\n') AS (stopword:chararray);
...
STORE top5_words INTO 'output/output_bai2_top5_words' USING PigStorage(';');
STORE category_count_ordered INTO 'output/output_bai2_by_category' USING PigStorage(';');
STORE aspect_count_ordered INTO 'output/output_bai2_by_aspect' USING PigStorage(';');
